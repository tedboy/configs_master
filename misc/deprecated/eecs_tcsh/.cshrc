...
#-----------------my alias------------------------------------------#
	...
	alias greph 'grep \!* -ni . --color=always' #| non-recursive (grep-'h'ere)
	alias gobare 'cd /net/newberry/w/takanori/git/bare'
	...
	alias itd 'ssh  takanori@stat.itd.umich.edu'
	#alias itd2 'ssh  takanori@stat.itd.umich.edu'
	alias itdnew 'ssh takanori@scs-new.gpcc.itd.umich.edu'
...
#	alias gotool 'cd ~/users/takanori/study_toolbox'
	alias gocopy 'cd ~/Copy'
	alias godrop 'cd ~/Dropbox'
	alias gotex 'cd ~/Dropbox/research_dropbox/latex'
	alias gonew 'cd /n/newberry/w/takanori/'
	alias goweb 'cd /n/newberry/w/takanori/public/html_new/'
	alias goconfnewberry 'cd /n/newberry/w/takanori/git/configs_master'
	
	alias vncfreewill 'vncviewer freewill.psych.med.umich.edu:5933'
...
# Some limits that can be set, they are commented out for convienence.
	...
	#%=========================================================================%
	# more stuffs from me (tak)(08/14/2014 1:21:AM)
	#%=========================================================================%
