...
# Tak's edits
#=========================================================================#
snippet "tak_dasher_= (insert a -dasher-)" do |s|
  s.trigger = 'tak_dasher_='
  s.expansion = '=========================================================================
'
end

snippet t(:tak_a_href2) do |s|
  s.trigger = 'tak a_href2'
  s.expansion = '<a href="$1" target="_blank">$2</a>'
end

snippet "Try css this" do |s|
  s.trigger = 'tak link css'
  s.expansion = '<link rel="stylesheet" type="text/css" href="$1" />
'
  s.description = "Read this beautiful description"
end

snippet t(:tak_html_skeleton) do |s|
  s.trigger = 'tak_html skeleton'
